...
echo. About
Echo.
Echo. The Simple Calculator
Echo. Version 1.2 "The Very Huge GUI Update"
Echo. Created by: Mark Calton
Echo.
Echo. Use of the code only allowed with permission
Echo.
Echo. Using BatchGraphics (bg.exe). It is essential. Not a virus. DONT DELETE IT or...
Echo. ... it won't work!
Echo.
